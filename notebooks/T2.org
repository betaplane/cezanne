...
#+begin_src ipython :results raw :session :savefig "SMAP_SMOIS_avg.png"
  ...
  plt.set_cmap('cividis')
  x = smap.mean('time')
  pl = axs[0].pcolormesh(x.lon, x.lat, x, transform=crs.PlateCarree(), vmin=0, vmax=vmax)
  axs[0].scatter(*sta.loc[['CNFJB', 'CNFJQ'], ['lon', 'lat']].astype(float).as_matrix().T, marker='o', color='r', transform=crs.PlateCarree())
  ...
  axs[1].scatter(*sta.loc[['CNFJB', 'CNFJQ'], ['lon', 'lat']].astype(float).as_matrix().T, marker='o', color='r', transform=crs.PlateCarree())
  ...
  axs[2].scatter(*sta.loc[['CNFJB', 'CNFJQ'], ['lon', 'lat']].astype(float).as_matrix().T, marker='o', color='r', transform=crs.PlateCarree())
