...
T_raw = hh.stationize(hh.read_hdf({'condor': '/nfs/HPC/arno/data/station_raw_binned.h5'}, 'ta_c').drop('10', 1, 'elev'), 'avg') + 273.15
...
#+begin_src ipython :results raw :session :savefig "daily_err_cycle_raw_2clusters.png"
  T_raw = hh.stationize(hh.read_hdf({'condor': '/nfs/HPC/arno/data/station_raw_binned.h5'}, 'ta_c').drop('10', 1, level='elev'), 'avg') + 273.15
