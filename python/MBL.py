...
ds = xr.open_dataset('/sshfs/datos/sata1_modelosglobales/WRFOUT_OPERACIONAL/c01_2018031012/wrfout_d03_2018-03-10_12:00:00')
...
j = np.broadcast_to(np.arange(t.bottom_top.size).reshape((1, -1, 1, 1)), t.shape)
...
MBL = gp.isel(bottom_top_stag=i.fillna(0).astype(int)).where(LM==0) # bottom interface of that layer
